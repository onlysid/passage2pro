  ...
  return (
    <Tilt className="basis-[360px] grow flex items-stretch">
      <motion.div variants={fadeIn("right", "spring", 0.5 * index, 0.75)} className="w-full green-pink-gradient p-[3px] rounded-[20px] shadow-card">
        <div options={{ max: 45, scale: 1, speed: 450 }} className="bg-dark rounded-[20px] h-full py-5 px-12 min-h-[280px] flex justify-start items-center flex-col">
...
const About = () => {
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl">
        Developing young players and instilling confidence and self belief in each individual while allowing allowing them to express themselves as individuals in the correct way.
      </motion.p>
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl">
